define(["jquery", "signals", "jquery.easing", "mdetect"], function ($, Signal) {
  var _s = {};
  ...
  _de.$solarSystem = $("#meteor-journey");
  ...
  if (_s.ie9 === true) {
    SVGtoPNG(
      $()
        .add(_de.$setup)
        .add(_de.$userToggleSound)
        .add(_de.$userPlaySound)
        .add(_de.$userScroll)
        .add(_de.$userLowPerformance)
        .find("img")
    );
  }
